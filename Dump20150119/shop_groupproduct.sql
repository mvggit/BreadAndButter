...
CREATE TABLE `groupproduct` (
  ...
  `techdescgroupproduct` longtext CHARACTER SET utf8,
...
INSERT INTO `groupproduct` VALUES (1,'Пиво','Стелаж с пивом','Бочковое, солодовое, порошковое, другое...'),(2,'Лимонад','Стелаж с лимонадом','Лимонад из натуральных соков, из сиропов, из свежевыжатого сока...'),(3,'Минералка','Стелаж с минералкой','Минеральная вода из природных источников...'),(4,'Булочки','Булочки','Булочки');
